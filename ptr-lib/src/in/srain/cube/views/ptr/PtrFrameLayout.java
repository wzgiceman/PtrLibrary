 ...
 * support: pull to refresh / release to refresh / auto refresh / keep header view while refreshing / hide header view while
 * refreshing
...
public class PtrFrameLayout extends ViewGroup {
    ...
    private void sendDownEvent() {
        ...
        MotionEvent e = MotionEvent.obtain(last.getDownTime(), last.getEventTime(), MotionEvent.ACTION_DOWN, last.getX(), last
